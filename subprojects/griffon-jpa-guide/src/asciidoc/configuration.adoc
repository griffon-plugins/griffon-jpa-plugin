...
----
dependencies {
    griffon '{project-group}:griffon-jpa-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-jpa-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-jpa-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-jpa-plugin` BOM in your POM file, by placing the following
